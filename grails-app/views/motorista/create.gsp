...
<html>
    ...
    <body>
        <a href="#create-motorista" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-motorista" class="content scaffold-create" role="main">
            ...
            <g:form resource="${this.motorista}" method="POST">
                <fieldset class="form">
