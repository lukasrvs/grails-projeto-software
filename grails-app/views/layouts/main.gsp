  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
        ...
        <div class="sidebar-brand-text mx-3">SGT</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="${createLink(controller:'ordemDeCarregamento', action: 'index')}">Ordem de Carregamento</a>
            <a class="collapse-item" href="${createLink(controller:'pedido', action: 'index')}">Pedido</a>
            <a class="collapse-item" href="${createLink(controller:'rotas', action: 'index')}">Rotas</a>
          </div>
        </div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="${resource('dir': 'images', file: 'undraw_profile_1.svg')}" alt="...">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="${resource('dir': 'images', file: 'undraw_profile_2.svg')}" alt="...">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="${resource('dir': 'images', file: 'undraw_profile_3.svg')}" alt="...">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Seu José</span>
                <img class="img-profile rounded-circle" src="${resource(dir: 'images', file: 'undraw_profile.svg')}">
              </a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; SGT 2023</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
