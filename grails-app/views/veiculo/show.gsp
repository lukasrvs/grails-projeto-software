...
<html>
    ...
    <body>
        ...
        <div id="show-veiculo" class="content scaffold-show" role="main">
            ...
            <f:display bean="veiculo" />
            <g:form resource="${this.veiculo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.veiculo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
